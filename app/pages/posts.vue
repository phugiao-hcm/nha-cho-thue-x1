      ...
      <div class="flex flex-col md:flex-row gap-6 p-0 md:p-6 bg-gray-50">
        ...
        <main class="flex-1 order-1 md:order-none">
          ...
          <div class="flex justify-end mb-4 hidden">
            <FilterSidebar :show="showFilter" @close="closeFilter" />
          </div>
          ...
          <div class="space-y-4">
            ...
            <template v-else>
              ...
              >
                ...
                <img
                  :src="
                    hotel.thumbnail ? hotel.thumbnail : '/images/og-image.png'
                  "
                ...
                <div class="flex-1">
                  <NuxtLink
                    :to="
                      hotel?.numORoomAvailable === 0
                        ? ''
                        : `/phong-tro/${slugify(hotel.title)}-${hotel.id}`
                    "
                    :class="
                      hotel?.numORoomAvailable === 0
                        ? 'pointer-events-none'
                    ...
                    "
                    @click="
                      hotel?.numORoomAvailable > 0 && onClickViewRoomDetail
                    "
                  >
                    <h3
        ...
        >
          <div class="text-orange-500 font-medium">
            ...
            <p>
              <a href="tel:0937704598" class="text-blue-400 hover:underline"
                >0937 704 598</a
              >
            </p>
          </div>
          <div class="hidden">
            ...
            <div class="mb-6">
              ...
              >
                <span class="text-orange-500 font-medium">Xem trên bản đồ</span>
              </div>
            </div>
