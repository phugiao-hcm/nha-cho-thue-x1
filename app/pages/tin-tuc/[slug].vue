    ...
    >
        ...
        <div class="md:col-span-2 space-y-4">
            <div class="w-full mx-auto overflow-hidden grid grid-cols-1 gap-4">
                ...
                <p>
                    Thông tin mới, đầy đủ, hấp dẫn về thị trường bất động sản
                    Việt Nam thông qua dữ liệu lớn về giá, giao dịch, nguồn cung
                    - cầu và khảo sát thực tế của đội ngũ phóng viên, biên tập
            ...
            <div class="flex flex-wrap items-center gap-3 mt-2">
                <p class="text-red-600 text-2xl sm:text-xl font-semibold">
                    Giới Đầu Tư Vững Tin Vào La Tiên Villa Nhờ Nằm Trong Đô Thị
                    Quốc Tế Đã Vận Hành
                </p>
