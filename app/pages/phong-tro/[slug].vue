    ...
    <div class="md:col-span-2 space-y-4">
      <div class="w-full mx-auto overflow-hidden grid grid-cols-1 gap-4">
        ...
        <swiper
          ...
          class="w-full"
        >
          <swiper-slide v-for="(img, i) in property.photos" :key="'thumb-' + i">
            <img
              :src="img"
      ...
      <!-- Tiêu đề -->
      <h1 class="text-xl sm:text-lg md:text-xl font-bold text-gray-800 mt-2">
        {{ property.title }}
      </h1>
      ...
      <div class="mb-1 flex flex-wrap">
        <span class="text-sm text-gray-600 mr-2">Tiện ích xung quanh:</span>
        <span
      ...
      <div class="bg-white rounded-lg shadow p-4 mt-4 md:mt-6">
        ...
        >
          ...
          <button class="text-blue-600 font-semibold" @click="showPhone = true">
            Hiện SĐT
          </button>
        </div>
      </div>
...
useHead(() => ({
  title: property.value?.title || "Chi tiết phòng trọ",
}));
</script>
